    ...
    <div className="min-h-screen bg-background">
      <main className="container mx-auto px-4 py-12 space-y-20">
        ...
        <div className="text-center space-y-8">
          <h1 className="text-4xl sm:text-7xl font-bold bg-gradient-to-r from-calculator-text to-calculator-highlight bg-clip-text text-transparent tracking-tight">
            Marketverse_
          </h1>
          <p className="text-xl sm:text-2xl text-calculator-dim leading-relaxed tracking-tight">
            Create, train, and deploy AI trading agents in a gamified crypto market simulation.
          </p>
          <div className="flex justify-center gap-4">
            <Link href="/app">
              <Button className="calculator-button text-lg tracking-tight" size="lg">
                Enter App_
              </Button>
            </Link>
          </div>
        ...
        <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
          <Card className="calculator-display lcd-container border-2 hover:border-calculator-highlight/50 transition-colors">
            <CardContent className="p-8 text-center space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold tracking-tight">AI_AGENTS</h3>
                <p className="text-calculator-dim text-lg leading-relaxed tracking-tight">
          ...
          <Card className="calculator-display lcd-container border-2 hover:border-calculator-highlight/50 transition-colors">
            <CardContent className="p-8 text-center space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold tracking-tight">MARKET_SIM</h3>
                <p className="text-calculator-dim text-lg leading-relaxed tracking-tight">
          ...
          <Card className="calculator-display lcd-container border-2 hover:border-calculator-highlight/50 transition-colors">
            <CardContent className="p-8 text-center space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold tracking-tight">COMPETE_WIN</h3>
                <p className="text-calculator-dim text-lg leading-relaxed tracking-tight">
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="calculator-display lcd-container border-2">
            <CardContent className="p-8 space-y-6">
              <h2 className="text-3xl font-bold tracking-tight text-center">JOIN_WAITLIST</h2>
              <p className="text-calculator-dim text-xl text-center mb-8 tracking-tight">
